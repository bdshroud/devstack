...
const Footer = () => {
    ...
    return (
        <footer className="flex justify-between items-start my-20 gap-5 container mx-auto max-w-[1200px]">
            <div className="">
                <img className="mb-5" src={footerImg} alt="" />
                <p className="mb-5 text-gray-500 w-120">Curated tools, technologies, and resources for developers building
                    modern software.</p>
